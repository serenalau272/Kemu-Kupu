...
public class API {
     ...
     * @param JWTToken The token for this user. This may be null if you wish to send the request without authorisation.
     * @return a response instance.
     * @throws IllegalArgumentException thrown when one of the input paramaters is incorrect.
     * @throws IOException thrown when the service is unable to contact the server.
     */
    public static Response makeRequest(RequestMethod method, String path, String data, String JWTToken) throws IllegalArgumentException, IOException {
    ...
    /**
     * Collects the price of an avatar from the MainApp.getAPI().
