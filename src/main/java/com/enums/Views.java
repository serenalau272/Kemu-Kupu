...
/**
 * Represents the different views that may be loaded as fxml pages, to limit the
 * bugs that may appear
 */
public enum Views {
    MENU, GAMEMODE, TOPIC, QUIZ, EXIT, RESULTS, REWARD, PROFILE, SHOP, WHEEL, ACHIEVEMENT, SIGNIN, NEWUSER;
    
    /**
     * Get the name of the fxml file for this view.
